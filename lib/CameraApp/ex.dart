...
class _CameraPageState extends State<CameraPage> {
  ...
  void detect(String bytestring, width, height) async {
    ...
    //'https://qs9eqe954g.execute-api.us-east-1.amazonaws.com/detect';
        'https://aavl48ony0.execute-api.us-east-1.amazonaws.com/Prod/detect';
    ...
    return Row(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: Text("Gallery",style:textTheme().bodyLarge!.copyWith(color:Colors.teal.shade300)),
        ),
      ],
    );
  }
  ...
  Widget _footer() {
    return Row(
      ...
      children: [
        ...
        TextButton(onPressed: (){Get.toNamed('/cam');}, child: Text('sgdsgs'))
      ],
    );
  }
}
